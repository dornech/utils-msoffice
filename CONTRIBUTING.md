...
Welcome to the contributor guide of Microsoft Office utilities for Python based on PyWin32.
...
If you experience bugs or general issues with Microsoft Office utilities for Python based on PyWin32, please have a look
...
You can help improve the documentation of Microsoft Office utilities for Python based on PyWin32 by making them more readable
...
3. Clone this copy to your local disk:
   ...
   ```console
   git clone git@github.com:YourLogin/utils-msoffice.git
   cd utils-msoffice
   ```
